...
const excludedIds = {
    items: new Map<string, Set<string>>([
        ...
        ['1.0.0-hotfix3', new Set(['8981892b-ce2a-43dc-a08e-2b5e8f8884fc'])],
        ['5.0.0-Aug222025', new Set(['49c93b98-cd66-4d3a-923c-c4e2871e87fb', 'c6433adf-cebc-4b6a-9172-3d7b36f6b428'])]
    ]),
    skills: new Map<string, Set<string>>([
        ...
        ['2.0.0-May212025', new Set(['65a77e2d-6c13-46c2-ae28-c521502a8be3', 'b6936741-8ec9-42f1-a6ec-d76061141f7d', 'cac848c8-dc77-4277-ba9f-df282b9f36ef'])],
        ['5.0.0-Aug132025', new Set(['6e7328ed-f925-4ca6-8637-9625626e12d2'])],
        ['5.0.0-Aug192025', new Set(['7f097b31-c29e-4082-a835-6d6457c2d536'])]
    ])
};
