...
// TODO: Might need to add heroFilter to all of them.
export const merchantFilterMapping: { [key: string]: { name: string, tagStates?: Partial<Record<Tag | HiddenTag, TriState>>, sizeFilter?: Size[], tierFilter?: TierType[], heroFilter?: Hero[] } } = {
    ...
    "0ff275f7-60ef-4428-acb6-1a138d03152d": { name: "Eli", tagStates: { Potion: "on" } },
    "7bd967dd-4631-4252-bdff-ee0bd5e3ddb7": { name: "Flex", tagStates: { HealthMax: "on" } },
    ...
    "2708055d-a8be-4c2f-a8d6-574e884a254e": { name: "Herma", tagStates: { Regen: "on", Heal: "on" } },
    ...
    "e30d8bef-5bea-4e95-b4c2-e29e17325a82": { name: "Mr. Morland", tagStates: { Property: "on" } },
    "1a21931f-6183-4251-914b-c8f83dc58a30": { name: "Nautica", tagStates: { Aquatic: "on" } },
    ...
    "bcdaa6d4-9057-4ea1-8110-a2dae217c55f": { name: "Prospero", tagStates: { EconomyReference: "on" } },
