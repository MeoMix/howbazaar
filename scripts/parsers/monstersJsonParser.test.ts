...
import monstersJson from "./data/v2_Monsters.json" assert { type: "json" };
...
describe('monstersJsonParser', () => {
  ...
  it('should contain a Coconut Crab with two Sea Shells', () => {
    ...
    const seaShells = coconutCrab.items.filter(item => item.id === "9ad15f24-4def-4d82-8545-d73794cfbaf2");
