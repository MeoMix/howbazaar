...
<div>
    ...
    <Dropdown
        bind:open={isOpen}
        containerClass="divide-y z-50 bg-white dark:bg-bazaar-brown text-gray-700 dark:text-bazaar-tan700 rounded-lg border-gray-100 dark:border-bazaar-brown600 divide-gray-100 dark:divide-bazaar-brown600"
    >
