...
const data: ParsedSkillCard[] = [
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Diamond": {
        "tooltips": [
          "If you have at least 7 items, your items have their cooldowns reduced by 15%."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      "Bronze": {
        "tooltips": [
          "Your Burn items have +5% Crit Chance."
        ]
      },
      "Silver": {
        "tooltips": [
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Gold": {
        "tooltips": [
          "You have +15 Regen for each non-weapon item you have."
        ]
      },
      "Diamond": {
        "tooltips": [
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Gold": {
        "tooltips": [
          "The first 3 times you Shield each fight, Freeze 1 item(s) for 2 second(s)."
        ]
      },
      "Diamond": {
        "tooltips": [
          "The first 6 times you Shield each fight, Freeze 1 item(s) for 2 second(s)."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Silver": {
        "tooltips": [
          "You have 2 Regen for each Ammo item you have."
        ]
      },
      "Gold": {
        "tooltips": [
          "You have 4 Regen for each Ammo item you have."
        ]
      },
      "Diamond": {
        "tooltips": [
          "You have 6 Regen for each Ammo item you have."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Gold": {
        "tooltips": [
          "The first time you Freeze each fight, Slow all enemy items for 5 second(s)."
        ]
      },
      "Diamond": {
        "tooltips": [
          "The first time you Freeze each fight, Slow all enemy items for 7 second(s)."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Gold": {
        "tooltips": [
          "The first time you freeze, burn, slow, poison, and haste each fight, charge 1 item(s) 2 second(s)."
        ]
      },
      "Diamond": {
        "tooltips": [
          "The first time you freeze, burn, slow, poison, and haste each fight, charge 1 item(s) 3 second(s)."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Silver": {
        "tooltips": [
          "While your enemy has more health than you, your Heal and Regen items have their cooldowns reduced by 5%."
        ]
      },
      "Gold": {
        "tooltips": [
          "While your enemy has more health than you, your Heal and Regen items have their cooldowns reduced by 10%."
        ]
      },
      "Diamond": {
        "tooltips": [
          "While your enemy has more health than you, your Heal and Regen items have their cooldowns reduced by 15%."
        ]
      },
      "Legendary": {
        "tooltips": []
  ...
  },
  {
    ...
    "tiers": {
      ...
      "Silver": {
        "tooltips": [
          "The first 5 times times you slow each fight, Charge 1 Regen item 1 second(s)."
        ]
      },
      "Gold": {
        "tooltips": [
          "The first 10 times times you slow each fight, Charge 1 Regen item 1 second(s)."
        ]
      },
      "Diamond": {
        "tooltips": [
          "The first 15 times times you slow each fight, Charge 1 Regen item 1 second(s)."
        ]
      },
      "Legendary": {
        "tooltips": []
